        ...
        <div className="flex py-20 px-4 md:px-6 xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
          ...
          <div className="mt-12 flex  xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
            <p className="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-white">
              2022 Lendors LTD. All Rights Reserved
            </p>
            ...
            <div className="flex  justify-start md:justify-end items-start  w-full md:w-auto md:items-center space-x-6 ">
              <a href="https://twitter.com/elisee-paterne" className="text-white hover:text-gray-200 w-6" target={"_blank"}>
                <Twitter />
              </a>
              <a href="https://web.facebook.com/elisee.paterne/" className="text-white hover:text-gray-200 w-6" target={"_blank"}>
                <Facebook />
              </a>
              <a className="text-white hover:text-gray-200 w-6" href="https://github.com/paternetech" target={"_blank"}>
                <GitHub />
              </a>
            </div>
          </div>
